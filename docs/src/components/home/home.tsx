                  ...
                  <div className={`${dark ? "menu-d" : "menu"}`}>
                           ...
                           <div className="h-[100%] w-[100%] flex flex-col justify-center items-center text-center">
                                    <button 
                                             ...
                                             onClick={() => {
                                                      (document.getElementById("btn") as HTMLButtonElement).innerHTML = `Thank you for downloading!`;
                                                      (document.getElementById("btn") as HTMLButtonElement).classList.add("button-success");
                                                      setTimeout(() => {
                                                               (document.getElementById("btn") as HTMLButtonElement).innerHTML = `<img 
                                                               ...
                                                               alt="Windows"
                                                             /> Download`;
                                                             (document.getElementById("btn") as HTMLButtonElement).classList.remove("button-success");
                                                      }, 3000);
