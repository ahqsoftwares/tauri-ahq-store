...
export default function MobileIndex({ dark }: { dark: boolean }) {
  ...
  return (
    <div 
      className={`absolute h-screen w-screen flex justify-center items-center text-center ${dark ? "bg-gray-900" : "bg-white"}`}
    >
      <div
        className={`w-[95%] h-[80%] ${
      ...
      >
        <div className="flex flex-col justify-center text-center items-center">
          ...
          />
          <h1
            className={`block mt-auto ${dark ? "text-blue-700" : "text-blue-900"}`}
            style={{
              "fontSize": "3rem",
              "fontWeight": "bolder"
            }}
          >AHQ Store</h1>
          <span
            className={`text-red-700 font-extrabold text-2xl sm:text-3xl`}
          >
