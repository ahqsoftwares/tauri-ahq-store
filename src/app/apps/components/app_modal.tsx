...
export default function ShowModal(props: AppDataPropsModal) {
  ...
  const { accessPrefs: { install_apps } } = (window as any).prefs as { accessPrefs: { install_apps: boolean }};
      ...
      <div className="flex flex-col w-[100%] h-[100%]">
        ...
        <div className="flex w-[100%] h-[100%]">
          ...
          >
            ...
            {(isAdmin && install_apps) ? installed == "hidden" ? (
              <button
                ref={button}
                className="dui-btn dui-btn-active btn-info w-[60%] mb-4"
                style={{
              ...
              <button
                ref={button}
                className="dui-btn dui-btn-active dui-btn-error w-[60%] mb-4"
                style={{
                  color: "white"
                }}
                disabled={updating}
              ...
              <button
                ref={button}
                className="dui-btn dui-btn-active dui-btn-primary w-[60%] mb-4"
                onClick={async () => {
                  if (!working) {
                    setWorking(true);
              ...
              >
                Install
                  ...
                  className="dui-btn dui-btn-error text-white bg-red-700 hover:bg-red-700 border-red-700 hover:border-red-700 w-[60%] mb-4"
                >
                  No Permission
                </button>}
          </div>
